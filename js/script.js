...
function scrollCarousel(direction) {
  ...
  const itemWidth = container.querySelector(".carousel-item").offsetWidth + 10; 
...
let roomCount = 1;
const roomDisplay = document.getElementById('room-count');
...
decreasebtn.addEventListener('click', () => {
  if (roomCount > 1) {
    roomCount--;
    roomDisplay.innerText = `Rooms: ${roomCount}`;
  }
});
